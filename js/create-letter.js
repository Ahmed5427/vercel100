    ...
    async generateLetter(letterData) {
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(data.details || data.error || 'خطأ في الخادم');
            }
            ...
            if (error.message.includes('fetch')) {
                throw new Error('خطأ في الاتصال بالخادم. يرجى المحاولة مرة أخرى.');
            }
    ...
    async archiveLetter(archiveData) {
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(data.details || data.error || 'خطأ في حفظ الخطاب');
            }

            return data;
        } catch (error) {
            console.error('Archive Network or API Error:', error);
